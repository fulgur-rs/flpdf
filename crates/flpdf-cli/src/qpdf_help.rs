//! qpdf 11.9.0 help records from libqpdf/qpdf/auto_job_help.hh at pin
//! 3b97c9bd266b7c32ea36d3536e22dab77412886d.
//! Rendering follows `QPDFArgParser::getTopHelp`, `getAllHelp`, `getTopicHelp`, and `getHelp`.
...
static HELP_TOPICS: &[HelpTopic] = &[
    HelpTopic {
        name: r#"usage"#,
        short_text: r#"basic invocation"#,
        long_text: r#"Read a PDF file, apply transformations or modifications, and write
a new PDF file.
...
"#,
    ...
    HelpTopic {
        name: r#"exit-status"#,
        short_text: r#"meanings of qpdf's exit codes"#,
        long_text: r#"Meaning of exit codes:
...
"#,
    ...
    HelpTopic {
        name: r#"completion"#,
        short_text: r#"shell completion"#,
        long_text: r#"Shell completion is supported with bash and zsh. Use
...
"#,
    ...
    HelpTopic {
        name: r#"help"#,
        short_text: r#"information about qpdf"#,
        long_text: r#"Help options provide some information about qpdf itself. Help
options are only valid as the first and only command-line argument.
"#,
    },
    HelpTopic {
        name: r#"general"#,
        short_text: r#"general options"#,
        long_text: r#"General options control qpdf's behavior in ways that are not
directly related to the operation it is performing.
"#,
    },
    HelpTopic {
        name: r#"advanced-control"#,
        short_text: r#"tweak qpdf's behavior"#,
        long_text: r#"Advanced control options control qpdf's behavior in ways that would
...
"#,
    ...
    HelpTopic {
        ...
        short_text: r#"make structural PDF changes"#,
        long_text: r#"The options below tell qpdf to apply transformations that change
the structure without changing the content.
"#,
    },
    HelpTopic {
        name: r#"page-ranges"#,
        short_text: r#"page range syntax"#,
        long_text: r#"A full description of the page range syntax, with examples, can be
...
"#,
    ...
    HelpTopic {
        name: r#"modification"#,
        short_text: r#"change parts of the PDF"#,
        long_text: r#"Modification options make systematic changes to certain parts of
the PDF, causing the PDF to render differently from the original.
"#,
    },
    HelpTopic {
        name: r#"encryption"#,
        short_text: r#"create encrypted files"#,
        long_text: r#"Create encrypted files. Usage:
...
"#,
    ...
    HelpTopic {
        name: r#"page-selection"#,
        short_text: r#"select pages from one or more files"#,
        long_text: r#"Use the --pages option to select pages from multiple files. Usage:
...
"#,
    ...
    HelpTopic {
        name: r#"overlay-underlay"#,
        short_text: r#"overlay/underlay pages from other files"#,
        long_text: r#"These options allow pages from another file to be overlaid or
...
"#,
    ...
    HelpTopic {
        name: r#"attachments"#,
        short_text: r#"work with embedded files"#,
        long_text: r#"It is possible to list, add, or delete embedded files (also known
...
"#,
    ...
    HelpTopic {
        name: r#"pdf-dates"#,
        short_text: r#"PDF date format"#,
        long_text: r#"When a date is required, the date should conform to the PDF date
...
"#,
    ...
    HelpTopic {
        name: r#"add-attachment"#,
        short_text: r#"attach (embed) files"#,
        long_text: r#"The options listed below appear between --add-attachment and its
terminating "--".
"#,
    },
    HelpTopic {
        name: r#"copy-attachments"#,
        short_text: r#"copy attachments from another file"#,
        long_text: r#"The options listed below appear between --copy-attachments-from and
its terminating "--".
...
"#,
    ...
    HelpTopic {
        name: r#"inspection"#,
        short_text: r#"inspect PDF files"#,
        long_text: r#"These options provide tools for inspecting PDF files. When any of
...
"#,
    ...
    HelpTopic {
        name: r#"json"#,
        short_text: r#"JSON output for PDF information"#,
        long_text: r#"Show information about the PDF file in JSON format. Please see the
JSON chapter in the qpdf manual for details.
"#,
    },
    HelpTopic {
        name: r#"testing"#,
        short_text: r#"options for testing or debugging"#,
        long_text: r#"The options below are useful when writing automated test code that
includes files created by qpdf or when testing qpdf itself.
"#,
    },
];

static HELP_OPTIONS: &[HelpOption] = &[
    HelpOption {
        name: r#"--empty"#,
        topic: r#"usage"#,
        short_text: r#"use empty file as input"#,
        long_text: r#"Use in place of infile for an empty input. Especially useful
with --pages.
"#,
    },
    HelpOption {
        name: r#"--replace-input"#,
        topic: r#"usage"#,
        short_text: r#"overwrite input with output"#,
        long_text: r#"Use in place of outfile to overwrite the input file with the output.
"#,
    },
    HelpOption {
        name: r#"--job-json-file"#,
        topic: r#"usage"#,
        short_text: r#"job JSON file"#,
        long_text: r#"--job-json-file=file
...
"#,
    ...
    HelpOption {
        name: r#"--warning-exit-0"#,
        topic: r#"exit-status"#,
        short_text: r#"exit 0 even with warnings"#,
        long_text: r#"Use exit status 0 instead of 3 when warnings are present. When
combined with --no-warn, warnings are completely ignored.
"#,
    },
    HelpOption {
        name: r#"--completion-bash"#,
        topic: r#"completion"#,
        short_text: r#"enable bash completion"#,
        long_text: r#"Output a command that enables bash completion
"#,
    },
    HelpOption {
        name: r#"--completion-zsh"#,
        topic: r#"completion"#,
        short_text: r#"enable zsh completion"#,
        long_text: r#"Output a command that enables zsh completion
"#,
    },
    HelpOption {
        name: r#"--help"#,
        topic: r#"help"#,
        short_text: r#"provide help"#,
        long_text: r#"--help[=--option|topic]
...
"#,
    ...
    HelpOption {
        name: r#"--version"#,
        topic: r#"help"#,
        short_text: r#"show qpdf version"#,
        long_text: r#"Display the version of qpdf.
"#,
    },
    HelpOption {
        name: r#"--copyright"#,
        topic: r#"help"#,
        short_text: r#"show copyright information"#,
        long_text: r#"Display copyright and license information.
"#,
    },
    HelpOption {
        name: r#"--show-crypto"#,
        topic: r#"help"#,
        short_text: r#"show available crypto providers"#,
        long_text: r#"Show a list of available crypto providers, one per line. The
default provider is shown first.
"#,
    },
    HelpOption {
        name: r#"--job-json-help"#,
        topic: r#"help"#,
        short_text: r#"show format of job JSON"#,
        long_text: r#"Describe the format of the QPDFJob JSON input used by
--job-json-file.
"#,
    },
    HelpOption {
        name: r#"--password"#,
        topic: r#"general"#,
        short_text: r#"password for encrypted file"#,
        long_text: r#"--password=password
...
"#,
    ...
    HelpOption {
        name: r#"--password-file"#,
        topic: r#"general"#,
        short_text: r#"read password from a file"#,
        long_text: r#"--password-file=filename
...
"#,
    ...
    HelpOption {
        name: r#"--verbose"#,
        topic: r#"general"#,
        short_text: r#"print additional information"#,
        long_text: r#"Output additional information about various things qpdf is
...
"#,
    ...
    HelpOption {
        name: r#"--progress"#,
        topic: r#"general"#,
        short_text: r#"show progress when writing"#,
        long_text: r#"Indicate progress when writing files.
"#,
    },
    HelpOption {
        name: r#"--no-warn"#,
        topic: r#"general"#,
        short_text: r#"suppress printing of warning messages"#,
        long_text: r#"Suppress printing of warning messages. If warnings were
...
"#,
    ...
    HelpOption {
        name: r#"--deterministic-id"#,
        topic: r#"general"#,
        short_text: r#"generate ID deterministically"#,
        long_text: r#"Generate a secure, random document ID only using static
information, such as the page contents. Does not use the file's
name or attributes or the current time.
"#,
    },
    HelpOption {
        name: r#"--allow-weak-crypto"#,
        topic: r#"general"#,
        short_text: r#"allow insecure cryptographic algorithms"#,
        long_text: r#"Allow creation of files with weak cryptographic algorithms. This
option is necessary to create 40-bit files or 128-bit files that
use RC4 encryption.
"#,
    },
    HelpOption {
        name: r#"--keep-files-open"#,
        topic: r#"general"#,
        short_text: r#"manage keeping multiple files open"#,
        long_text: r#"--keep-files-open=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--keep-files-open-threshold"#,
        topic: r#"general"#,
        short_text: r#"set threshold for --keep-files-open"#,
        long_text: r#"--keep-files-open-threshold=count
...
"#,
    ...
    HelpOption {
        name: r#"--password-is-hex-key"#,
        topic: r#"advanced-control"#,
        short_text: r#"provide hex-encoded encryption key"#,
        long_text: r#"Provide the underlying file encryption key as a hex-encoded
string rather than supplying a password. This is an expert
option.
"#,
    },
    HelpOption {
        name: r#"--suppress-password-recovery"#,
        topic: r#"advanced-control"#,
        short_text: r#"don't try different password encodings"#,
        long_text: r#"Suppress qpdf's usual behavior of attempting different encodings
of a password that contains non-ASCII Unicode characters if the
first attempt doesn't succeed.
"#,
    },
    HelpOption {
        name: r#"--password-mode"#,
        topic: r#"advanced-control"#,
        short_text: r#"tweak how qpdf encodes passwords"#,
        long_text: r#"--password-mode=mode
...
"#,
    ...
    HelpOption {
        name: r#"--suppress-recovery"#,
        topic: r#"advanced-control"#,
        short_text: r#"suppress error recovery"#,
        long_text: r#"Avoid attempting to recover when errors are found in a file's
cross reference table or stream lengths.
"#,
    },
    HelpOption {
        name: r#"--ignore-xref-streams"#,
        topic: r#"advanced-control"#,
        short_text: r#"use xref tables rather than streams"#,
        long_text: r#"Ignore any cross-reference streams in the file, falling back to
cross-reference tables or triggering document recovery.
"#,
    },
    HelpOption {
        name: r#"--linearize"#,
        topic: r#"transformation"#,
        short_text: r#"linearize (web-optimize) output"#,
        long_text: r#"Create linearized (web-optimized) output files.
"#,
    },
    HelpOption {
        name: r#"--encrypt"#,
        topic: r#"transformation"#,
        short_text: r#"start encryption options"#,
        long_text: r#"--encrypt [options] --
...
"#,
    ...
    HelpOption {
        name: r#"--decrypt"#,
        topic: r#"transformation"#,
        short_text: r#"remove encryption from input file"#,
        long_text: r#"Create an unencrypted output file even if the input file was
encrypted. Normally qpdf preserves whatever encryption was
present on the input file. This option overrides that behavior.
"#,
    },
    HelpOption {
        name: r#"--remove-restrictions"#,
        topic: r#"transformation"#,
        short_text: r#"remove security restrictions from input file"#,
        long_text: r#"Remove restrictions associated with digitally signed PDF files.
...
"#,
    ...
    HelpOption {
        name: r#"--copy-encryption"#,
        topic: r#"transformation"#,
        short_text: r#"copy another file's encryption details"#,
        long_text: r#"--copy-encryption=file
...
"#,
    ...
    HelpOption {
        name: r#"--encryption-file-password"#,
        topic: r#"transformation"#,
        short_text: r#"supply password for --copy-encryption"#,
        long_text: r#"--encryption-file-password=password
...
"#,
    ...
    HelpOption {
        name: r#"--qdf"#,
        topic: r#"transformation"#,
        short_text: r#"enable viewing PDF code in a text editor"#,
        long_text: r#"Create a PDF file suitable for viewing in a text editor and even
...
"#,
    ...
    HelpOption {
        name: r#"--no-original-object-ids"#,
        topic: r#"transformation"#,
        short_text: r#"omit original object IDs in qdf"#,
        long_text: r#"Omit comments in a QDF file indicating the object ID an object
had in the original file.
"#,
    },
    HelpOption {
        name: r#"--compress-streams"#,
        topic: r#"transformation"#,
        short_text: r#"compress uncompressed streams"#,
        long_text: r#"--compress-streams=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--decode-level"#,
        topic: r#"transformation"#,
        short_text: r#"control which streams to uncompress"#,
        long_text: r#"--decode-level=parameter
...
"#,
    ...
    HelpOption {
        name: r#"--stream-data"#,
        topic: r#"transformation"#,
        short_text: r#"control stream compression"#,
        long_text: r#"--stream-data=parameter
...
"#,
    ...
    HelpOption {
        name: r#"--recompress-flate"#,
        topic: r#"transformation"#,
        short_text: r#"uncompress and recompress flate"#,
        long_text: r#"The default generalized compression scheme used by PDF is flate,
...
"#,
    ...
    HelpOption {
        name: r#"--compression-level"#,
        topic: r#"transformation"#,
        short_text: r#"set compression level for flate"#,
        long_text: r#"--compression-level=level
...
"#,
    ...
    HelpOption {
        name: r#"--normalize-content"#,
        topic: r#"transformation"#,
        short_text: r#"fix newlines in content streams"#,
        long_text: r#"--normalize-content=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--object-streams"#,
        topic: r#"transformation"#,
        short_text: r#"control use of object streams"#,
        long_text: r#"--object-streams=mode
...
"#,
    ...
    HelpOption {
        name: r#"--preserve-unreferenced"#,
        topic: r#"transformation"#,
        short_text: r#"preserve unreferenced objects"#,
        long_text: r#"Preserve all objects from the input even if not referenced.
"#,
    },
    HelpOption {
        name: r#"--remove-unreferenced-resources"#,
        topic: r#"transformation"#,
        short_text: r#"remove unreferenced page resources"#,
        long_text: r#"--remove-unreferenced-resources=parameter
...
"#,
    ...
    HelpOption {
        name: r#"--preserve-unreferenced-resources"#,
        topic: r#"transformation"#,
        short_text: r#"use --remove-unreferenced-resources=no"#,
        long_text: r#"Synonym for --remove-unreferenced-resources=no. Use that instead.
"#,
    },
    HelpOption {
        name: r#"--newline-before-endstream"#,
        topic: r#"transformation"#,
        short_text: r#"force a newline before endstream"#,
        long_text: r#"For an extra newline before endstream. Using this option enables
qpdf to preserve PDF/A when rewriting such files.
"#,
    },
    HelpOption {
        name: r#"--coalesce-contents"#,
        topic: r#"transformation"#,
        short_text: r#"combine content streams"#,
        long_text: r#"If a page has an array of content streams, concatenate them into
a single content stream.
"#,
    },
    HelpOption {
        name: r#"--externalize-inline-images"#,
        topic: r#"transformation"#,
        short_text: r#"convert inline to regular images"#,
        long_text: r#"Convert inline images to regular images.
"#,
    },
    HelpOption {
        name: r#"--ii-min-bytes"#,
        topic: r#"transformation"#,
        short_text: r#"set minimum size for --externalize-inline-images"#,
        long_text: r#"--ii-min-bytes=size-in-bytes
...
"#,
    ...
    HelpOption {
        name: r#"--min-version"#,
        topic: r#"transformation"#,
        short_text: r#"set minimum PDF version"#,
        long_text: r#"--min-version=version
...
"#,
    ...
    HelpOption {
        name: r#"--force-version"#,
        topic: r#"transformation"#,
        short_text: r#"set output PDF version"#,
        long_text: r#"--force-version=version
...
"#,
    ...
    HelpOption {
        name: r#"--pages"#,
        topic: r#"modification"#,
        short_text: r#"begin page selection"#,
        long_text: r#"--pages [--file=]file [options] [...] --
...
"#,
    ...
    HelpOption {
        name: r#"--file"#,
        topic: r#"modification"#,
        short_text: r#"source for pages"#,
        long_text: r#"--file=file
...
"#,
    ...
    HelpOption {
        name: r#"--range"#,
        topic: r#"modification"#,
        short_text: r#"page range"#,
        long_text: r#"--range=numeric-range
...
"#,
    ...
    HelpOption {
        name: r#"--collate"#,
        topic: r#"modification"#,
        short_text: r#"collate with --pages"#,
        long_text: r#"--collate[=n[,m,...]]
...
"#,
    ...
    HelpOption {
        name: r#"--split-pages"#,
        topic: r#"modification"#,
        short_text: r#"write pages to separate files"#,
        long_text: r#"--split-pages[=n]
...
"#,
    ...
    HelpOption {
        name: r#"--overlay"#,
        topic: r#"modification"#,
        short_text: r#"begin overlay options"#,
        long_text: r#"--overlay file [options] --
...
"#,
    ...
    HelpOption {
        name: r#"--underlay"#,
        topic: r#"modification"#,
        short_text: r#"begin underlay options"#,
        long_text: r#"--underlay file [options] --
...
"#,
    ...
    HelpOption {
        name: r#"--flatten-rotation"#,
        topic: r#"modification"#,
        short_text: r#"remove rotation from page dictionary"#,
        long_text: r#"For each page that is rotated using the /Rotate key in the
...
"#,
    ...
    HelpOption {
        name: r#"--flatten-annotations"#,
        topic: r#"modification"#,
        short_text: r#"push annotations into content"#,
        long_text: r#"--flatten-annotations=parameter
...
"#,
    ...
    HelpOption {
        name: r#"--rotate"#,
        topic: r#"modification"#,
        short_text: r#"rotate pages"#,
        long_text: r#"--rotate=[+|-]angle[:page-range]
...
"#,
    ...
    HelpOption {
        name: r#"--generate-appearances"#,
        topic: r#"modification"#,
        short_text: r#"generate appearances for form fields"#,
        long_text: r#"PDF form fields consist of values and appearances, which may be
...
"#,
    ...
    HelpOption {
        name: r#"--optimize-images"#,
        topic: r#"modification"#,
        short_text: r#"use efficient compression for images"#,
        long_text: r#"Attempt to use DCT (JPEG) compression for images that fall
...
"#,
    ...
    HelpOption {
        name: r#"--oi-min-width"#,
        topic: r#"modification"#,
        short_text: r#"minimum width for --optimize-images"#,
        long_text: r#"--oi-min-width=width

Don't optimize images whose width is below the specified value.
"#,
    },
    HelpOption {
        name: r#"--oi-min-height"#,
        topic: r#"modification"#,
        short_text: r#"minimum height for --optimize-images"#,
        long_text: r#"--oi-min-height=height
...
"#,
    ...
    HelpOption {
        name: r#"--oi-min-area"#,
        topic: r#"modification"#,
        short_text: r#"minimum area for --optimize-images"#,
        long_text: r#"--oi-min-area=area-in-pixels

Don't optimize images whose area in pixels is below the specified value.
"#,
    },
    HelpOption {
        name: r#"--keep-inline-images"#,
        topic: r#"modification"#,
        short_text: r#"exclude inline images from optimization"#,
        long_text: r#"Prevent inline images from being considered by --optimize-images.
"#,
    },
    HelpOption {
        name: r#"--remove-page-labels"#,
        topic: r#"modification"#,
        short_text: r#"remove explicit page numbers"#,
        long_text: r#"Exclude page labels (explicit page numbers) from the output file.
"#,
    },
    HelpOption {
        name: r#"--set-page-labels"#,
        topic: r#"modification"#,
        short_text: r#"number pages for the entire document"#,
        long_text: r#"--set-page-labels label-spec ... --
...
"#,
    ...
    HelpOption {
        name: r#"--user-password"#,
        topic: r#"encryption"#,
        short_text: r#"specify user password"#,
        long_text: r#"--user-password=user-password

Set the user password of the encrypted file.
"#,
    },
    HelpOption {
        name: r#"--owner-password"#,
        topic: r#"encryption"#,
        short_text: r#"specify owner password"#,
        long_text: r#"--owner-password=owner-password
...
"#,
    ...
    HelpOption {
        name: r#"--bits"#,
        topic: r#"encryption"#,
        short_text: r#"specify encryption key length"#,
        long_text: r#"--bits={48|128|256}
...
"#,
    ...
    HelpOption {
        ...
        topic: r#"encryption"#,
        short_text: r#"restrict document accessibility"#,
        long_text: r#"--accessibility=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--annotate"#,
        topic: r#"encryption"#,
        short_text: r#"restrict document annotation"#,
        long_text: r#"--annotate=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--assemble"#,
        topic: r#"encryption"#,
        short_text: r#"restrict document assembly"#,
        long_text: r#"--assemble=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--extract"#,
        topic: r#"encryption"#,
        short_text: r#"restrict text/graphic extraction"#,
        long_text: r#"--extract=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--form"#,
        topic: r#"encryption"#,
        short_text: r#"restrict form filling"#,
        long_text: r#"--form=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--modify-other"#,
        topic: r#"encryption"#,
        short_text: r#"restrict other modifications"#,
        long_text: r#"--modify-other=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--modify"#,
        topic: r#"encryption"#,
        short_text: r#"restrict document modification"#,
        long_text: r#"--modify=modify-opt
...
"#,
    ...
    HelpOption {
        name: r#"--print"#,
        topic: r#"encryption"#,
        short_text: r#"restrict printing"#,
        long_text: r#"--print=print-opt
...
"#,
    ...
    HelpOption {
        name: r#"--cleartext-metadata"#,
        topic: r#"encryption"#,
        short_text: r#"don't encrypt metadata"#,
        long_text: r#"If specified, don't encrypt document metadata even when
...
"#,
    ...
    HelpOption {
        name: r#"--use-aes"#,
        topic: r#"encryption"#,
        short_text: r#"use AES with 128-bit encryption"#,
        long_text: r#"--use-aes=[y|n]
...
"#,
    ...
    HelpOption {
        name: r#"--allow-insecure"#,
        topic: r#"encryption"#,
        short_text: r#"allow empty owner passwords"#,
        long_text: r#"Allow creation of PDF files with empty owner passwords and
...
"#,
    ...
    HelpOption {
        name: r#"--force-V4"#,
        topic: r#"encryption"#,
        short_text: r#"force V=4 in encryption dictionary"#,
        long_text: r#"This option is for testing and is never needed in practice since
...
"#,
    ...
    HelpOption {
        name: r#"--force-R5"#,
        topic: r#"encryption"#,
        short_text: r#"use unsupported R=5 encryption"#,
        long_text: r#"Use an undocumented, unsupported, deprecated encryption
...
"#,
    ...
    HelpOption {
        name: r#"--to"#,
        topic: r#"overlay-underlay"#,
        short_text: r#"destination pages for underlay/overlay"#,
        long_text: r#"--to=page-range
...
"#,
    ...
    HelpOption {
        name: r#"--from"#,
        topic: r#"overlay-underlay"#,
        short_text: r#"source pages for underlay/overlay"#,
        long_text: r#"--from=[page-range]
...
"#,
    ...
    HelpOption {
        name: r#"--repeat"#,
        topic: r#"overlay-underlay"#,
        short_text: r#"overlay/underlay pages to repeat"#,
        long_text: r#"--repeat=page-range
...
"#,
    ...
    HelpOption {
        name: r#"--add-attachment"#,
        topic: r#"attachments"#,
        short_text: r#"start add attachment options"#,
        long_text: r#"--add-attachment file [options] --
...
"#,
    ...
    HelpOption {
        name: r#"--copy-attachments-from"#,
        topic: r#"attachments"#,
        short_text: r#"start copy attachment options"#,
        long_text: r#"--copy-attachments-from file [options] --
...
"#,
    ...
    HelpOption {
        name: r#"--remove-attachment"#,
        topic: r#"attachments"#,
        short_text: r#"remove an embedded file"#,
        long_text: r#"--remove-attachment=key
...
"#,
    ...
    HelpOption {
        name: r#"--key"#,
        topic: r#"add-attachment"#,
        short_text: r#"specify attachment key"#,
        long_text: r#"--key=key
...
"#,
    ...
    HelpOption {
        name: r#"--filename"#,
        topic: r#"add-attachment"#,
        short_text: r#"set attachment's displayed filename"#,
        long_text: r#"--filename=name
...
"#,
    ...
    HelpOption {
        name: r#"--creationdate"#,
        topic: r#"add-attachment"#,
        short_text: r#"set attachment's creation date"#,
        long_text: r#"--creationdate=date
...
"#,
    ...
    HelpOption {
        name: r#"--moddate"#,
        topic: r#"add-attachment"#,
        short_text: r#"set attachment's modification date"#,
        long_text: r#"--moddate=date
...
"#,
    ...
    HelpOption {
        name: r#"--mimetype"#,
        topic: r#"add-attachment"#,
        short_text: r#"attachment mime type, e.g. application/pdf"#,
        long_text: r#"--mimetype=type/subtype
...
"#,
    ...
    HelpOption {
        name: r#"--description"#,
        topic: r#"add-attachment"#,
        short_text: r#"set attachment's description"#,
        long_text: r#"--description="text"
...
"#,
    ...
    HelpOption {
        name: r#"--replace"#,
        topic: r#"add-attachment"#,
        short_text: r#"replace attachment with same key"#,
        long_text: r#"Indicate that any existing attachment with the same key should
...
"#,
    ...
    HelpOption {
        name: r#"--prefix"#,
        topic: r#"copy-attachments"#,
        short_text: r#"key prefix for copying attachments"#,
        long_text: r#"--prefix=prefix
...
"#,
    ...
    HelpOption {
        name: r#"--is-encrypted"#,
        topic: r#"inspection"#,
        short_text: r#"silently test whether a file is encrypted"#,
        long_text: r#"Silently exit with a code indicating the file's encryption status:
...
"#,
    ...
    HelpOption {
        name: r#"--requires-password"#,
        topic: r#"inspection"#,
        short_text: r#"silently test a file's password"#,
        long_text: r#"Silently exit with a code indicating the file's password status:
...
"#,
    ...
    HelpOption {
        name: r#"--check"#,
        topic: r#"inspection"#,
        short_text: r#"partially check whether PDF is valid"#,
        long_text: r#"Check the structure of the PDF file as well as a number of other
...
"#,
    ...
    HelpOption {
        name: r#"--show-encryption"#,
        topic: r#"inspection"#,
        short_text: r#"information about encrypted files"#,
        long_text: r#"Show document encryption parameters. Also show the document's
...
"#,
    ...
    HelpOption {
        name: r#"--show-encryption-key"#,
        topic: r#"inspection"#,
        short_text: r#"show key with --show-encryption"#,
        long_text: r#"When used with --show-encryption or --check, causes the
underlying encryption key to be displayed.
"#,
    },
    HelpOption {
        name: r#"--check-linearization"#,
        topic: r#"inspection"#,
        short_text: r#"check linearization tables"#,
        long_text: r#"Check to see whether a file is linearized and, if so, whether
the linearization hint tables are correct.
"#,
    },
    HelpOption {
        name: r#"--show-linearization"#,
        topic: r#"inspection"#,
        short_text: r#"show linearization hint tables"#,
        long_text: r#"Check and display all data in the linearization hint tables.
"#,
    },
    HelpOption {
        name: r#"--show-xref"#,
        topic: r#"inspection"#,
        short_text: r#"show cross reference data"#,
        long_text: r#"Show the contents of the cross-reference table or stream (object
...
"#,
    ...
    HelpOption {
        name: r#"--show-object"#,
        topic: r#"inspection"#,
        short_text: r#"show contents of an object"#,
        long_text: r#"--show-object={trailer|obj[,gen]}
...
"#,
    ...
    HelpOption {
        name: r#"--raw-stream-data"#,
        topic: r#"inspection"#,
        short_text: r#"show raw stream data"#,
        long_text: r#"When used with --show-object, if the object is a stream, write
...
"#,
    ...
    HelpOption {
        name: r#"--filtered-stream-data"#,
        topic: r#"inspection"#,
        short_text: r#"show filtered stream data"#,
        long_text: r#"When used with --show-object, if the object is a stream, write
...
"#,
    ...
    HelpOption {
        name: r#"--show-npages"#,
        topic: r#"inspection"#,
        short_text: r#"show number of pages"#,
        long_text: r#"Print the number of pages in the input file on a line by itself.
Useful for scripts.
"#,
    },
    HelpOption {
        name: r#"--show-pages"#,
        topic: r#"inspection"#,
        short_text: r#"display page dictionary information"#,
        long_text: r#"Show the object and generation number for each page dictionary
...
"#,
    ...
    HelpOption {
        name: r#"--with-images"#,
        topic: r#"inspection"#,
        short_text: r#"include image details with --show-pages"#,
        long_text: r#"When used with --show-pages, also shows the object and
generation numbers for the image objects on each page.
"#,
    },
    HelpOption {
        name: r#"--list-attachments"#,
        topic: r#"inspection"#,
        short_text: r#"list embedded files"#,
        long_text: r#"Show the key and stream number for each embedded file. Combine
with --verbose for more detailed information.
"#,
    },
    HelpOption {
        name: r#"--show-attachment"#,
        topic: r#"inspection"#,
        short_text: r#"export an embedded file"#,
        long_text: r#"--show-attachment=key
...
"#,
    ...
    HelpOption {
        name: r#"--json"#,
        topic: r#"json"#,
        short_text: r#"show file in JSON format"#,
        long_text: r#"--json[=version]
...
"#,
    ...
    HelpOption {
        name: r#"--json-help"#,
        topic: r#"json"#,
        short_text: r#"show format of JSON output"#,
        long_text: r#"--json-help[=version]
...
"#,
    ...
    HelpOption {
        name: r#"--json-key"#,
        topic: r#"json"#,
        short_text: r#"limit which keys are in JSON output"#,
        long_text: r#"--json-key=key
...
"#,
    ...
    HelpOption {
        name: r#"--json-object"#,
        topic: r#"json"#,
        short_text: r#"limit which objects are in JSON"#,
        long_text: r#"--json-object={trailer|obj[,gen]}
...
"#,
    ...
    HelpOption {
        name: r#"--json-stream-data"#,
        topic: r#"json"#,
        short_text: r#"how to handle streams in json output"#,
        long_text: r#"--json-stream-data={none|inline|file}
...
"#,
    ...
    HelpOption {
        name: r#"--json-stream-prefix"#,
        topic: r#"json"#,
        short_text: r#"prefix for json stream data files"#,
        long_text: r#"--json-stream-prefix=file-prefix
...
"#,
    ...
    HelpOption {
        name: r#"--json-output"#,
        topic: r#"json"#,
        short_text: r#"apply defaults for JSON serialization"#,
        long_text: r#"--json-output[=version]
...
"#,
    ...
    HelpOption {
        name: r#"--json-input"#,
        topic: r#"json"#,
        short_text: r#"input file is qpdf JSON"#,
        long_text: r#"Treat the input file as a JSON file in qpdf JSON format. See the
"qpdf JSON Format" section of the manual for information about
how to use this option.
"#,
    },
    HelpOption {
        name: r#"--update-from-json"#,
        topic: r#"json"#,
        short_text: r#"update a PDF from qpdf JSON"#,
        long_text: r#"--update-from-json=qpdf-json-file
...
"#,
    ...
    HelpOption {
        name: r#"--static-id"#,
        topic: r#"testing"#,
        short_text: r#"use a fixed document ID"#,
        long_text: r#"Use a fixed value for the document ID. This is intended for
testing only. Never use it for production files. See also
qpdf --help=--deterministic-id.
"#,
    },
    HelpOption {
        name: r#"--static-aes-iv"#,
        topic: r#"testing"#,
        short_text: r#"use a fixed AES vector"#,
        long_text: r#"Use a static initialization vector for AES-CBC. This is intended
...
"#,
    ...
    HelpOption {
        name: r#"--linearize-pass1"#,
        topic: r#"testing"#,
        short_text: r#"save pass 1 of linearization"#,
        long_text: r#"--linearize-pass1=file
...
"#,
    ...
    HelpOption {
        name: r#"--test-json-schema"#,
        topic: r#"testing"#,
        short_text: r#"test generated json against schema"#,
        long_text: r#"This is used by qpdf's test suite to check consistency between
the output of qpdf --json and the output of qpdf --json-help.
"#,
    },
    HelpOption {
        name: r#"--report-memory-usage"#,
        topic: r#"testing"#,
        short_text: r#"best effort report of memory usage"#,
        long_text: r#"This is used by qpdf's performance test suite to report the
maximum amount of memory used in supported environments.
"#,
    },
];

pub(super) fn render_top(program_name: &str) -> Vec<u8> {
    let mut output = String::new();
    render_top_into(&mut output, program_name);
    output.push_str(HELP_FOOTER);
    output.into_bytes()
}

pub(super) fn render(argument: &[u8], program_name: &str) -> Option<Vec<u8>> {
    let output = if argument == b"all" {
        render_all(program_name)
    } else if let Some(option) = HELP_OPTIONS
        .iter()
        .find(|option| option.name.as_bytes() == argument)
    {
        render_record(option.long_text, None)
    } else {
        let topic = HELP_TOPICS
            .iter()
            .find(|topic| topic.name.as_bytes() == argument)?;
        render_record(topic.long_text, Some(topic.name))
    };
    Some(output.into_bytes())
}

fn render_top_into(output: &mut String, program_name: &str) {
    output.push_str("Run ");
    output.push('"');
    output.push_str(program_name);
    output.push_str(" --help=topic");
    output.push('"');
    output.push_str(" for help on a topic.");
    output.push('\n');
    output.push_str("Run ");
    output.push('"');
    output.push_str(program_name);
    output.push_str(" --help=--option");
    output.push('"');
    output.push_str(" for help on an option.");
    output.push('\n');
    output.push_str("Run ");
    output.push('"');
    output.push_str(program_name);
    output.push_str(" --help=all");
    output.push('"');
    output.push_str(" to see all available help.");
    output.push('\n');
    output.push('\n');
    output.push_str("Topics:");
    output.push('\n');
    let mut topics: Vec<_> = HELP_TOPICS.iter().collect();
    topics.sort_unstable_by(|left, right| left.name.cmp(right.name));
    for topic in topics {
        output.push_str("  ");
        output.push_str(topic.name);
        output.push_str(": ");
        output.push_str(topic.short_text);
        output.push('\n');
    }
}

fn render_all(program_name: &str) -> String {
    let mut output = String::new();
    render_top_into(&mut output, program_name);
    ...
    for topic in topics {
        ...
        output.push_str(topic.short_text);
        output.push_str(") ==\n\n");
        render_record_body(&mut output, topic.long_text, Some(topic.name));
    }

    let mut options: Vec<_> = HELP_OPTIONS.iter().collect();
    options.sort_unstable_by(|left, right| left.name.cmp(right.name));
    for option in options {
        output.push('\n');
        output.push_str("== ");
        output.push_str(option.name);
        output.push_str(" (");
        output.push_str(option.short_text);
        output.push_str(") ==\n\n");
        render_record_body(&mut output, option.long_text, None);
    }
...
fn render_record(long_text: &str, related_topic: Option<&str>) -> String {
    let mut output = String::new();
    render_record_body(&mut output, long_text, related_topic);
    output.push_str(HELP_FOOTER);
    output
}

fn render_record_body(output: &mut String, long_text: &str, related_topic: Option<&str>) {
    output.push_str(long_text);

    if let Some(topic) = related_topic {
        let mut related: Vec<_> = HELP_OPTIONS
            .iter()
            .filter(|option| option.topic == topic)
            .collect();
        related.sort_unstable_by(|left, right| left.name.cmp(right.name));
        if !related.is_empty() {
            output.push_str("\nRelated options:\n");
