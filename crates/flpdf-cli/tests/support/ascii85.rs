//! Test-only ASCII85 fixture builder for CLI integration tests.
//!
//! This is intentionally local to tests so fixture construction stays
//! independent from production stream encoding support.
