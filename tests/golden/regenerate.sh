...
# C++ API mutation golden (flpdf-kirsw): the CLI cannot retain 1 0 while
# replacing 1 1, so this fixture is generated by the pinned qpdf C++ API.
echo "Generating removed-source-container-preserve-qpdf-api.pdf.hex ..."
"$ROOT/scripts/generate-qpdf-api-golden.sh" \
    "$FIX/three-page-objstm.pdf" \
    "$FIX/removed-source-container-preserve-qpdf-api.pdf.hex"
...
qpdf --static-id --warning-exit-0 \
    "$FIX/linearize-indirect-extensions.pdf" \
    "$REF/linearize-indirect-extensions/adbe-preserve.pdf"
echo "linearize-indirect-extensions/adbe-preserve.pdf"
