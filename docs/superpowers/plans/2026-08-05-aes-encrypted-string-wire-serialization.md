...
- [ ] **Step 1: Add nested compact/QDF and error-propagation tests**
...
- [ ] **Step 3: Implement the compact and QDF recursive serializers**
...
- [ ] **Step 4: Run callback tests and the object test module**
...
- [ ] **Step 5: Commit the serializer boundary**
...
- [ ] **Step 1: Add deterministic representation and lifecycle tests**
...
- [ ] **Step 2: Run the new module test filter and observe RED**
...
- [ ] **Step 3: Record exact encryption revision in `EncryptionContext`**
...
- [ ] **Step 4: Implement emission-time scalar encryption**
...
- [ ] **Step 5: Run emitter, encryption-state, and security tests**
...
- [ ] **Step 1: Add exact-five-key tests**
...
- [ ] **Step 2: Run the `/Encrypt` helper test and observe RED**
...
- [ ] **Step 4: Run unit and existing encryption dictionary tests**
...
- [ ] **Step 5: Commit `/Encrypt` emission**
...
- [ ] **Step 1: Add public compact/QDF regressions**
...
- [ ] **Step 2: Run compact/QDF regressions and observe RED**
...
- [ ] **Step 3: Wire full-rewrite emission-time encryption**
...
- [ ] **Step 4: Remove obsolete branch behavior and QDF rejection**
...
- [ ] **Step 5: Run full-writer focused and crate suites**
...
- [ ] **Step 6: Commit full-rewrite cutover**
...
- [ ] **Step 1: Add AES string-syntax and convergence tests**
...
- [ ] **Step 2: Run linearized regressions and observe RED**
...
- [ ] **Step 3: Wire the emitter through linearized helpers**
...
- [ ] **Step 4: Run linearization encryption and full linearization tests**
...
- [ ] **Step 5: Commit the linearized cutover**
...
- [ ] **Step 1: Probe qpdf 11.9.0 with deterministic fixtures**
...
- [ ] **Step 2: Regenerate and verify module correspondence docs**
...
- [ ] **Step 4: Run fresh changed-line coverage**
...
- [ ] **Step 5: Commit generated docs and verification notes**
...
- [ ] **Step 6: Persist Beads and push the implementation branch**
