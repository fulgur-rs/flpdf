...
**調査日:** 2026-09-17（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.138`）。
現行 `origin/main=5c9214b8ff2a65f10fc553252708933898f7fb25` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
2026-09-17 の current-main audit anchor は `origin/main=5c9214b8ff2a65f10fc553252708933898f7fb25`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 2174 qpdf citations / 914 flpdf citations /
