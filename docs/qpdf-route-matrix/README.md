...
現行 `origin/main=e268ec3386255f88d7447e99ec345a1fac69a8f8` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`e268ec3386255f88d7447e99ec345a1fac69a8f8`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=e268ec3386255f88d7447e99ec345a1fac69a8f8`、pinned qpdf は
