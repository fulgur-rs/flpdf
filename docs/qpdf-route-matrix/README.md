...
**調査日:** 2026-09-15（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.114`）。
現行 `origin/main=8f68515d20d19304c129e96e80a4206ddd796d11` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-15 の現行 `origin/main` (`8f68515d20d19304c129e96e80a4206ddd796d11`) を基準に、
...
classified row は 259 行で、canonical 146 / mixed 113 / bridge 0 / unknown 0（bridge + mixed は113行）である。
