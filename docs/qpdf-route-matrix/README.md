...
**調査日:** 2026-09-17（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.137`）。
現行 `origin/main=f091b01d53d00170b786a2bd141cd77a64d35d91` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
