...
現行 `origin/main=950c1e55af7c99a2b674a265e932ce18ce853996` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`950c1e55af7c99a2b674a265e932ce18ce853996`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=950c1e55af7c99a2b674a265e932ce18ce853996`、pinned qpdf は
