...
### 6.2 計測（2026-09-04、HEAD `0f4f5e7c`）
...
crates/flpdf/src/object_handle.rs::ObjectHandle::get_key: prod 143 (28 files) / test 454
...
crates/flpdf/src/object_handle.rs::ObjectHandle::has_key: prod 9 (7 files) / test 101
    crates/flpdf-qtest-tools/src/clean.rs 2, crates/flpdf/src/page_object_helper.rs 2, crates/flpdf-qtest-tools/src/tokenizer_runner.rs 1, crates/flpdf/src/embedded_files.rs 1, crates/flpdf/src/object_handle.rs 1, crates/flpdf/src/optimization/inherited_attrs.rs 1, crates/flpdf/src/pages.rs 1
crates/flpdf/src/reader.rs::Pdf::get_all_objects: prod 8 (6 files) / test 7
...
crates/flpdf/src/reader.rs::Pdf::object_refs: prod 14 (5 files) / test 44
    crates/flpdf/src/linearization/plan.rs 5, crates/flpdf/src/reader.rs 4, crates/flpdf-qtest-tools/src/tokenizer_runner.rs 3, crates/flpdf/src/nntree.rs 1, crates/flpdf/src/writer/object_streams/eligibility.rs 1
crates/flpdf/src/reader.rs::Pdf::live_object_refs: prod 8 (6 files) / test 32
    crates/flpdf-qtest-tools/src/orchestrator.rs 2, crates/flpdf/src/linearization/plan.rs 2, crates/flpdf/src/job/page_merge.rs 1, crates/flpdf/src/writer/object_streams/eligibility.rs 1, crates/flpdf/src/writer/reachability.rs 1, crates/flpdf/src/writer/rewrite_renumber.rs 1
...
crates/flpdf/src/reader/resolver.rs::remove_object_preserving_handle: prod 1 (1 files) / test 0
    crates/flpdf/src/reader.rs 1
crates/flpdf/src/reader.rs::Pdf::delete_object: prod 2 (2 files) / test 8
    crates/flpdf/src/signatures.rs 1, crates/flpdf/src/writer/reachability.rs 1
crates/flpdf/src/reader.rs::Pdf::synchronize_cache_with_resolver_xref: prod 7 (1 files) / test 2
    crates/flpdf/src/reader.rs 7
crates/flpdf/src/pdf.rs::legacy_resolution_state_synced: prod 5 (3 files) / test 0
    crates/flpdf/src/engine.rs 2, crates/flpdf/src/reader.rs 2, crates/flpdf/src/pdf.rs 1
crates/flpdf/src/reader.rs::Pdf::mark_object_handle_dirty: prod 172 (48 files) / test 63
...
crates/flpdf/src/pdf.rs::dirty_object_refs: prod 7 (3 files) / test 8
    crates/flpdf/src/reader.rs 4, crates/flpdf/src/engine.rs 2, crates/flpdf/src/pdf.rs 1
crates/flpdf/src/pdf.rs::handle_mutated_object_refs: prod 6 (3 files) / test 0
    crates/flpdf/src/reader.rs 3, crates/flpdf/src/engine.rs 2, crates/flpdf/src/pdf.rs 1
...
crates/flpdf/src/reader.rs::Pdf::promote_resolved_object_stream_members: prod 1 (1 files) / test 1
    crates/flpdf/src/reader.rs 1
crates/flpdf/src/pdf.rs::compressed_member_parents: prod 6 (3 files) / test 4
    crates/flpdf/src/reader.rs 3, crates/flpdf/src/engine.rs 2, crates/flpdf/src/pdf.rs 1
crates/flpdf/src/reader/resolver.rs::ResolverCore: prod 5 (1 files) / test 0
    crates/flpdf/src/reader/resolver.rs 5
crates/flpdf/src/reader/resolver.rs::object_cache: prod 12 (1 files) / test 1
    crates/flpdf/src/reader/resolver.rs 12
...
crates/flpdf/src/object_handle.rs::ObjectHandle::try_get_key: prod 349 (59 files) / test 232
...
crates/flpdf/src/reader.rs::Pdf::replace_object: prod 17 (10 files) / test 117
...
crates/flpdf/src/parser.rs::content_good_count: prod 10 (1 files) / test 0
    crates/flpdf/src/parser.rs 10
crates/flpdf/src/parser.rs::content_give_up: prod 7 (1 files) / test 0
    crates/flpdf/src/parser.rs 7
...
crates/flpdf/src/reader/resolver.rs::qpdf_exception_what: prod 1 (1 files) / test 0
    crates/flpdf/src/reader/resolver.rs 1
crates/flpdf/src/reader/resolver.rs::route_warning: prod 6 (1 files) / test 3
    crates/flpdf/src/reader/resolver.rs 6
crates/flpdf/src/pdf.rs::resolution_fallbacks_remaining: prod 9 (3 files) / test 0
    crates/flpdf/src/reader.rs 6, crates/flpdf/src/engine.rs 2, crates/flpdf/src/pdf.rs 1
...
crates/flpdf/src/reader/resolver.rs::reconstructed_xref: prod 12 (2 files) / test 23
    crates/flpdf/src/reader/resolver.rs 8, crates/flpdf/src/reader.rs 4
crates/flpdf/src/reader/resolver.rs::attempt_recovery: prod 10 (1 files) / test 0
    crates/flpdf/src/reader/resolver.rs 10
crates/flpdf/src/reader/resolver.rs::repair_diagnostics: prod 97 (15 files) / test 168
    crates/flpdf/src/xref.rs 62, crates/flpdf/src/reader/resolver.rs 10, crates/flpdf/src/job/check.rs 5, crates/flpdf-qtest-tools/src/metadata.rs 4, crates/flpdf/src/engine.rs 4, crates/flpdf-cli/src/main.rs 2, crates/flpdf/src/job/inspection.rs 2, crates/flpdf-qtest-tools/src/driver/mod.rs 1, crates/flpdf-qtest-tools/src/driver/test_10_17.rs 1, crates/flpdf-qtest-tools/src/driver/test_56_63.rs 1, crates/flpdf-qtest-tools/src/driver/test_64_71.rs 1, crates/flpdf-qtest-tools/src/driver/test_80_87.rs 1, crates/flpdf/src/job/lifecycle.rs 1, crates/flpdf/src/json/document.rs 1, crates/flpdf/src/reader.rs 1
...
crates/flpdf/src/object_handle.rs::write_stream_json: prod 2 (1 files) / test 8
...
crates/flpdf/src/linearization/writer.rs::write_linearized: prod 1 (1 files) / test 2
    crates/flpdf/src/linearization/writer.rs 1
...
crates/flpdf/src/writer/object_streams/planning.rs::ObjectStreamGroup: prod 19 (4 files) / test 0
    crates/flpdf/src/writer/plain/plan.rs 10, crates/flpdf/src/writer/rewrite_renumber.rs 6, crates/flpdf/src/writer/object_streams/planning.rs 2, crates/flpdf/src/writer.rs 1
...
crates/flpdf/src/writer/object_streams/eligibility.rs::compressible_objgens_qpdf_plan: prod 7 (6 files) / test 0
    crates/flpdf/src/writer/object_streams/planning.rs 2, crates/flpdf/src/linearization/plan.rs 1, crates/flpdf/src/linearization/writer.rs 1, crates/flpdf/src/writer.rs 1, crates/flpdf/src/writer/object_streams/eligibility.rs 1, crates/flpdf/src/writer/plain/plan.rs 1
crates/flpdf/src/reader/resolver.rs::source_xref_entries: prod 32 (9 files) / test 3
    crates/flpdf/src/reader/resolver.rs 11, crates/flpdf/src/reader.rs 5, crates/flpdf/src/writer.rs 5, crates/flpdf/src/linearization/writer.rs 3, crates/flpdf/src/engine.rs 2, crates/flpdf/src/linearization/plan.rs 2, crates/flpdf/src/writer/object_streams/planning.rs 2, crates/flpdf/src/writer/plain/plan.rs 1, crates/flpdf/src/writer/rewrite_renumber.rs 1
...
crates/flpdf/src/job/json.rs::write_json: prod 10 (3 files) / test 21
...
crates/flpdf/src/job/lifecycle.rs::QPDFJob::run: prod 17 (11 files) / test 318
...
crates/flpdf/src/job/page_split.rs::QPDFJob::split_pages: prod 23 (2 files) / test 15
    crates/flpdf-cli/src/main.rs 13, crates/flpdf/src/job/lifecycle.rs 10
...
crates/flpdf/src/job/lifecycle.rs::run_configured_inspection: prod 1 (1 files) / test 0
    crates/flpdf/src/job/lifecycle.rs 1
crates/flpdf/src/job/check.rs::QPDFJob::check: prod 21 (2 files) / test 147
    crates/flpdf/src/job/lifecycle.rs 13, crates/flpdf-cli/src/main.rs 8
crates/flpdf/src/job/attachments.rs::QPDFJob::list_attachments: prod 10 (2 files) / test 2
    crates/flpdf/src/job/lifecycle.rs 6, crates/flpdf-cli/src/main.rs 4
...
crates/flpdf/src/job/image_optimization.rs::optimize_images: prod 23 (2 files) / test 2
    crates/flpdf-cli/src/main.rs 19, crates/flpdf/src/job/lifecycle.rs 4
...
crates/flpdf/src/job/lifecycle.rs::QPDFJob::has_warnings: prod 12 (3 files) / test 6
...
crates/flpdf/src/job/lifecycle.rs::QPDFJob::open_document: prod 12 (2 files) / test 1
    crates/flpdf/src/linearization/writer.rs 11, crates/flpdf/src/job/lifecycle.rs 1
crates/flpdf/src/job/lifecycle.rs::QPDFJob::open: prod 68 (26 files) / test 1254
    crates/flpdf-cli/src/main.rs 26, crates/flpdf-qtest-tools/src/bin/qpdf_ctest.rs 5, crates/flpdf-qtest-tools/src/driver/test_88_98.rs 3, crates/flpdf-qtest-tools/src/metadata.rs 3, crates/flpdf/src/job/lifecycle.rs 3, crates/flpdf/src/reader.rs 3, crates/flpdf-qtest-tools/src/renumber.rs 2, crates/flpdf/src/engine.rs 2, crates/flpdf/src/linearization/check.rs 2, crates/flpdf/src/linearization/show.rs 2, crates/flpdf/src/qdf_fix.rs 2, crates/flpdf-qtest-tools/src/bin/unicode_filenames.rs 1, crates/flpdf-qtest-tools/src/character_encoding.rs 1, crates/flpdf-qtest-tools/src/driver/mod.rs 1, crates/flpdf-qtest-tools/src/driver/test_26_33.rs 1, crates/flpdf-qtest-tools/src/driver/test_56_63.rs 1, crates/flpdf-qtest-tools/src/driver/test_64_71.rs 1, crates/flpdf-qtest-tools/src/driver/test_80_87.rs 1, crates/flpdf-qtest-tools/src/large_file.rs 1, crates/flpdf-qtest-tools/src/output.rs 1, crates/flpdf/src/filespec_helper/embedded_file_stream.rs 1, crates/flpdf/src/job/page_combine.rs 1, crates/flpdf/src/json/document.rs 1, crates/flpdf/src/json/input.rs 1, crates/flpdf/src/pipeline/stream_codecs_oracle.rs 1, crates/flpdf/src/writer.rs 1
```
...
D29 のように symbol が main に存在せず（PR #1486 のみ）行セルも tracker も「どちらでもない」
と判定する行が 1 つある。表の行数は 25（E-9 が 2 symbol で 2 行を占めるため、行 ID の
異なり数は 24）。
...
| A15 | `synchronize_cache_with_resolver_xref` | 8 / test 1 | 7 / test 2 | 行が prod に数えた 8 件のうち `crates/flpdf/src/reader.rs:1592` は項目単位 `#[cfg(test)]` の `Pdf::remove_object_handle`（A13 自身が `crates/flpdf/src/reader.rs:1587-1588` を test-only と認めている）の中。加えて行は `crates/flpdf/src/reader/resolver.rs` 側の test 参照 1 件を数えていない | tracker |
...
| A24 | `promote_resolved_object_stream_members` | 2 | 1 | 行が挙げた 2 箇所のうち `crates/flpdf/src/reader.rs:1597` は A15 と同じ項目単位 `#[cfg(test)]` の関数の中 | tracker |
...
| D29 | `qpdf_preserve_source_objstm` | 1 | 0 | この識別子は PR #1486 の diff にのみ存在し、main（本 worktree）には無い | どちらでもない。**0 は「cutover 済み」ではなく「未マージ」** |
...
4. **A13 / A14 / A17** — tombstone に触る変異 API。**A14 は本節の最初の cutover（§7.3）で
   prod 2→1 になっているので、ここでは `crates/flpdf/src/signatures.rs` の 1 consumer だけを扱う。**
...
qpdf 呼び出し順を壊さない理由: §5.E 第 3 行（入力は必ず `doProcessOnce` 経由で開き、
...
| 3 | `crates/flpdf/src/page_extract.rs:218`（`extract_pages`） | library 専用。`crates/flpdf-cli/src/main.rs` からの呼び出しは無い | **なし。** `extract_pages` は qpdf に対応物のない flpdf 固有のライブラリ機能（`.claude/rules/qpdf-port-design-patterns.md` 8 の根拠 3）で、sweep 撤去の正当化は「この pass 自体が qpdf 非対応（D27）で、writer の enqueue walk が同じ判定を内包する」という一般論だけになる。さらに `crates/flpdf/src/lib.rs` 冒頭 doc が `extract_pages` を「returns a *minimal* new document」と規定しており、rebuild 由来の孤児を残すことはその記述と矛盾する。**同じスライスの中で「別手段で minimal を保つ」か「doc を改める」かを決める**こと。決めずに撤去しない |
...
- `crates/flpdf/src/writer/reachability.rs::sweep_unreachable_objects_except`
  ...
  番号割り当てだけが違う）。D3 / D11 の担当であり、本 cutover では触らない。
- A14 `crates/flpdf/src/reader.rs::Pdf::delete_object` 自体。本 cutover は consumer を 1 つ減らすだけで、
  `Pdf::delete_object` の意味は変えない。
...
- **cutover 後の期待値がこの qpdf 出力であることの裏取り（control 2 本）**:
  1. `probe: qpdf --static-id --preserve-unreferenced --pages . 1 -- two.pdf` と flpdf 同等
     （`--remove-unreferenced-resources` を省略 = 既定 `auto` → このフィクスチャでは
     `RemoveUnreferencedResources::No` に落ちて sweep が走らない）→ **双方 967 バイトで byte 一致**。
     つまり「sweep を走らせない」ことが即ち qpdf 一致である。
...
- fixture はまだリポジトリに無い。本 cutover の issue が `tests/fixtures/` へ追加し、
  byte test を `.github/workflows/ci.yml` の bytes-identical テスト列挙へ手で足す
...
1〜3 がすべて満たされ、かつ
`python3 scripts/qpdf-route-callers.py --root . --symbol delete_object` が
`prod 1 (1 files)`（`crates/flpdf/src/signatures.rs` のみ）を返すこと。
これが確認できたら A14 が 1 consumer だけの slice になるので、§7.2.1 の 4 を次に着手する
...
| A-3 | A | `remove_object_preserving_handle`（A13）が qpdf 出力に与える差。qpdf の `removeObject` は cache cell ごと erase し og も切る（`libqpdf/QPDF.cc:1995-2005`） | `qpdf --json=2` と flpdf の同等出力を、`Pdf::delete_object` 相当の操作（qpdf 側は `replaceObject(og, newNull())`）を挟んだ前後で比較する | A13, A14 |
