...
現行 `origin/main=c12a520fff07c2d3cded52234b08bc0c4b377a7d` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-15 の現行 `origin/main` (`c12a520fff07c2d3cded52234b08bc0c4b377a7d`) を基準に、
...
2026-09-15 の current-main audit anchor は `origin/main=c12a520fff07c2d3cded52234b08bc0c4b377a7d`、pinned qpdf は
