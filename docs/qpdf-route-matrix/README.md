...
現行 `origin/main=46eb9ae7e2e41647f8c086a05a5bb288b3814be7` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`46eb9ae7e2e41647f8c086a05a5bb288b3814be7`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=46eb9ae7e2e41647f8c086a05a5bb288b3814be7`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 2132 qpdf citations / 915 flpdf citations /
