...
rowsを検証する。2026-09-14 の現行 `origin/main` (`fe422bc5e`) での集計は次のとおり。
...
2026-09-14 の current-main audit anchor は `origin/main=fe422bc5e`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
1054 qpdf citations / 907 flpdf citations / 259 logical rows、分類は
