...
現行 `origin/main=84a46010bd7c1774ba64869d8a70af5f720f01f9` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
2026-09-17 の current-main audit anchor は `origin/main=84a46010bd7c1774ba64869d8a70af5f720f01f9`、pinned qpdf は
