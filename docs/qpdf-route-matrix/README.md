...
rowsを検証する。2026-09-14 の現行 `origin/main` (`ef5609ba5`) での集計は次のとおり。
...
2026-09-14 の current-main audit anchor は `origin/main=ef5609ba5`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**この revision を適用した tree で** 1216 qpdf citations / 920 flpdf citations /
