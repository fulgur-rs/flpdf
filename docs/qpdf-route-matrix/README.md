...
現行 `origin/main=81c73c29acdce924ac6ee219dec082322dfa6c5d` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`81c73c29acdce924ac6ee219dec082322dfa6c5d`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=81c73c29acdce924ac6ee219dec082322dfa6c5d`、pinned qpdf は
