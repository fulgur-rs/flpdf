...
現行 `origin/main=31f8377ac` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-15 の現行 `origin/main` (`31f8377ac`) を基準に、
...
2026-09-15 の current-main audit anchor は `origin/main=31f8377ac`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 1284 qpdf citations / 912 flpdf citations /
