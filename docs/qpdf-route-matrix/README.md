...
**調査日:** 2026-09-17（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.135`）。
現行 `origin/main=369a86174ced674f7798ed42cf21ec13adf86d2b` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
2026-09-17 の current-main audit anchor は `origin/main=369a86174ced674f7798ed42cf21ec13adf86d2b`、pinned qpdf は
