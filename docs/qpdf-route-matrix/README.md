...
現行 `origin/main=dc5108a5ecb74f3b804fa8b54ecca0dadf148338` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`dc5108a5ecb74f3b804fa8b54ecca0dadf148338`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=dc5108a5ecb74f3b804fa8b54ecca0dadf148338`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 2095 qpdf citations / 915 flpdf citations /
