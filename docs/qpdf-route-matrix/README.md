...
現行 `origin/main=c3af00aa2bba4492423c9adc31f3677abd08c553` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-15 の現行 `origin/main` (`c3af00aa2bba4492423c9adc31f3677abd08c553`) を基準に、
...
2026-09-15 の current-main audit anchor は `origin/main=c3af00aa2bba4492423c9adc31f3677abd08c553`、pinned qpdf は
