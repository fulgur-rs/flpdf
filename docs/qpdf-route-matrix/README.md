...
**調査日:** 2026-09-16（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.123`）。
現行 `origin/main=923fe5bf4c148bb504901434390e51eeaaef4d06` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`923fe5bf4c148bb504901434390e51eeaaef4d06`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=923fe5bf4c148bb504901434390e51eeaaef4d06`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 2055 qpdf citations / 909 flpdf citations /
259 logical rows、分類は
canonical 154 / mixed 105 / bridge 0 / unknown 0。A〜E の160行だけを数える
...
classified row は 259 行で、canonical 154 / mixed 105 / bridge 0 / unknown 0（bridge + mixed は105行）である。
