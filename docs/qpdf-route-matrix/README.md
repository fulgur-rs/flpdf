...
現行 `origin/main=d048ca48c266edad0da93516899eb4c2428fa70c` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`d048ca48c266edad0da93516899eb4c2428fa70c`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=d048ca48c266edad0da93516899eb4c2428fa70c`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 1435 qpdf citations / 909 flpdf citations /
259 logical rows、分類は
canonical 153 / mixed 106 / bridge 0 / unknown 0。A〜E の160行だけを数える
...
classified row は 259 行で、canonical 153 / mixed 106 / bridge 0 / unknown 0（bridge + mixed は106行）である。
