...
**調査日:** 2026-09-15（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.104`）。
現行 `origin/main=830c3bf78` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-15 の現行 `origin/main` (`830c3bf78`) を基準に、
...
2026-09-15 の current-main audit anchor は `origin/main=830c3bf78`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 1274 qpdf citations / 912 flpdf citations /
259 logical rows、分類は
canonical 137 / mixed 120 / bridge 2 / unknown 0。A〜E の160行だけを数える
...
classified row は 259 行で、canonical 137 / mixed 120 / bridge 2 / unknown 0（bridge + mixed は122行）である。
