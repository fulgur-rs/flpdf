...
**調査日:** 2026-09-15（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.113`）。
現行 `origin/main=192d18db5497dc11a8e0b71ca1841b61f3586fb4` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-15 の現行 `origin/main` (`192d18db5497dc11a8e0b71ca1841b61f3586fb4`) を基準に、
...
2026-09-15 の current-main audit anchor は `origin/main=192d18db5497dc11a8e0b71ca1841b61f3586fb4`、pinned qpdf は
...
canonical 145 / mixed 114 / bridge 0 / unknown 0。A〜E の160行だけを数える
...
classified row は 259 行で、canonical 145 / mixed 114 / bridge 0 / unknown 0（bridge + mixed は114行）である。
...
7. **E-27 / E-28** — `.48.93` で test 0/1 の既知stream warning bridgeを canonical pipe/loggerへ、`.48.107` / `.48.108` / `.48.109` / `.48.110` / `.48.111` で test 2 / 3 / 6 / 11 / 19 のcaller-side resolve/accessor bridgeを、`.48.112` / `.48.113` で test21のshallowCopy bridgeを canonical routeへ移行済み。残る mixed case/APIだけを追加調査し、A〜D全行の確定を待たない。
