...
**調査日:** 2026-09-16（再監査 `flpdf-3yn9.48`、文書更新 `flpdf-3yn9.48.134`）。
現行 `origin/main=802d7dc4c144ac588355c4eaf505975679615b01` と pinned qpdf source に基づき、領域別表の分類・責務境界・既存issueとの対応を更新した。
...
rowsを検証する。2026-09-16 の現行 `origin/main` (`802d7dc4c144ac588355c4eaf505975679615b01`) を基準に、
...
2026-09-16 の current-main audit anchor は `origin/main=802d7dc4c144ac588355c4eaf505975679615b01`、pinned qpdf は
11.9.0 commit `3b97c9bd266b7c32ea36d3536e22dab77412886d` である。checker の実測は
**今回の変更を適用した tree で** 2135 qpdf citations / 915 flpdf citations /
...
classified row は 259 行で、canonical 158 / mixed 101 / bridge 0 / unknown 0（bridge + mixed は101行）である。
