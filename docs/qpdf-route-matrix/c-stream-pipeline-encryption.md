...
| 分類 | 件数 | 行 |
|---|---|---|
| canonical | 30 | C1, C2, C3, C5, C6, C8, C10, C11, C12, C13, C14, C15, C16, C17, C18, C20, C24, C25, C30, C31, C32, C33, C34, C35, C36, C37, C38, C39, C40, C41 |
| mixed | 10 | C4, C7, C9, C21, C22, C26, C27, C29, C42, C44 |
| bridge | 2 | C28, C43 |
