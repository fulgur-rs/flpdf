...
| `crates/flpdf/src/json_inspect.rs` | correspondence | QPDFJob.cc doJSON* section builders plus QPDF_json.cc writeJSON serialization and side-file lifecycle responsibilities |
