...
| `crates/flpdf/src/object_handle.rs` | correspondence | \`QPDFObjectHandle\`, \`QPDFObject\`, and \`QPDFValue\` identity and payload ownership, plus \`QPDFWriter.cc\` \`unparseObject\`/\`writeTrailer\` writer-emission primitives (\`unparse_object\`/\`unparse_object_qdf\`/\`unparse_stream_body\`/\`unparse_stream_body_qdf\`/\`unparse_trailer\`) |
...
| `crates/flpdf/src/writer/encrypted_strings.rs` | correspondence | QPDFWriter.cc:1567-1599 string-unparse, QPDFWriter.cc:1761-1796 object data-key lifecycle, and QPDFWriter.cc:2244-2256 encryption-dictionary emission responsibilities |
