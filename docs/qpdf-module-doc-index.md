...
| `crates/flpdf/src/json_inspect.rs` | correspondence | QPDFJob.cc doJSON* section builders, QPDF_json.cc writeJSON serialization and side-file lifecycle, and QPDFObjectHandle::getJSON object serialization responsibilities |
