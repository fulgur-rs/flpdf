...
| `crates/flpdf/src/job/image_optimization.rs` | correspondence | QPDFJob::ImageOptimizer and Pl_DCT image compression |
...
| `crates/flpdf/src/job/rotate_spec.rs` | correspondence | \`QPDFJob::parseRotationParameter\` |
...
| `crates/flpdf/src/linearization/back_patch.rs` | correspondence | QPDFWriter.cc linearization parameter-dictionary compatibility helper |
...
| `crates/flpdf/src/writer/object/unparse_object_tests.rs` | correspondence | tests for \`QPDFWriter::unparseObject\`, \`unparseChild\`, and \`writeTrailer\` writer emission |
